...
public class MedHelicopterAdapterConfiguration {
    ...
    public void   setDefaultState(String v)               { this.defaultState = v; }

    public double getDefaultLatitude()                    { return defaultLatitude; }
    public void   setDefaultLatitude(double v)            { this.defaultLatitude = v; }

    public double getDefaultLongitude()                   { return defaultLongitude; }
    public void   setDefaultLongitude(double v)           { this.defaultLongitude = v; }

    public String getDefaultPatientId()                   { return defaultPatientId; }
    public void   setDefaultPatientId(String v)           { this.defaultPatientId = v; }

    public String getDefaultHospitalId()                  { return defaultHospitalId; }
    public void   setDefaultHospitalId(String v)          { this.defaultHospitalId = v; }

    public String getDefaultHomeBase()                    { return defaultHomeBase; }
    public void   setDefaultHomeBase(String v)            { this.defaultHomeBase = v; }

    public double getDefaultFuelLevel()                   { return defaultFuelLevel; }
    public void   setDefaultFuelLevel(double v)           { this.defaultFuelLevel = v; }

    public int    getDefaultMissionsSinceMaintenance()    { return defaultMissionsSinceMaintenance; }
    public void   setDefaultMissionsSinceMaintenance(int v){ this.defaultMissionsSinceMaintenance = v; }

    public boolean isDefaultNeedsRefueling()              { return defaultNeedsRefueling; }
    public void    setDefaultNeedsRefueling(boolean v)    { this.defaultNeedsRefueling = v; }

    public boolean isDefaultNeedsMaintenance()            { return defaultNeedsMaintenance; }
    public void    setDefaultNeedsMaintenance(boolean v)  { this.defaultNeedsMaintenance = v; }

    public double getDefaultTimestamp()                   { return defaultTimestamp; }
    public void   setDefaultTimestamp(double v)           { this.defaultTimestamp = v; }

    public double getDefaultTripDistanceSinceEmergency()  { return defaultTripDistanceSinceEmergency; }
    public void   setDefaultTripDistanceSinceEmergency(double v) { this.defaultTripDistanceSinceEmergency = v; }
}
