...
public class MedCarAdapterConfiguration {

    private String defaultState = MedCarKeywords.STATE_AT_REST;
    private double defaultLatitude = 0.0;
    private double defaultLongitude = 0.0;
    private String defaultPatientId = "null";
    private String defaultHomeBaseId = "null";
    ...
    public MedCarAdapterConfiguration() {
    }
    ...
    public MedCarAdapterConfiguration(
        ...
        this.defaultHomeBaseId = defaultHomeBaseId;
    ...
    public String getDefaultHomeBaseId() {
        return defaultHomeBaseId;
    }

    public void setDefaultHomeBaseId(String v) {
        this.defaultHomeBaseId = v;
    }
